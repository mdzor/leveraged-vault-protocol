...
contract MockERC3643Fund is ERC20, IERC3643Fund {
    ...
    constructor(string memory name, string memory symbol, address _underlyingToken)
        ERC20(name, symbol)
    {
    ...
    /**
     * @dev Override balanceOf to satisfy both ERC20 and IERC3643Fund
     */
    function balanceOf(address account)
        public
        view
        override(ERC20, IERC3643Fund)
        returns (uint256)
    {
    ...
    /**
     * @dev Override totalSupply to satisfy both ERC20 and IERC3643Fund
     */
    function totalSupply() public view override(ERC20, IERC3643Fund) returns (uint256) {
        return super.totalSupply();
    }

    /**
     * @dev Override transfer to satisfy both ERC20 and IERC3643Fund
     */
